        ...
        <div class="small-box bg-primary">
          <div class="inner">
            <h3>
              ...
              if(isset($department))
              {
                echo sizeof($department); // Display the number of departments
              }
              else{
                echo 0; // Display 0 if departments array is not set
              }
              ?>
            </h3>
            <p>Departments</p>
        ...
        <div class="small-box bg-maroon">
          <div class="inner">
            <h3>
              ...
              if(isset($staff))
              {
                echo sizeof($staff); // Display the number of staff members
              }
              else{
                echo 0; // Display 0 if staff array is not set
              }
              ?>
            </h3>
            <p>Staff</p>
        ...
        <div class="small-box bg-red">
          <div class="inner">
            <h3>
              ...
              if(isset($leave))
              {
                echo sizeof($leave); // Display the number of leave requests
              }
              else{
                echo 0; // Display 0 if leave array is not set
              }
              ?>
            </h3>
            <p>Leave Requests</p>
        ...
        <div class="small-box bg-green">
          <div class="inner">
            <h3>
              ...
              {
                foreach ($salary as $s) {
                  echo $s['total']; // Display total salary paid
                }
                
              }
              else{
                echo 0; // Display 0 if salary array is not set
              }
              ?>
            </h3>
            <p>Salary Paid</p>
